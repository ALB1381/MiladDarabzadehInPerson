...
self.TrackJS = self.trackJs = (function (g, l, n) {
    ...
    }; var r = function (a, b, d, e, c, h, g) { this.util = a; this.log = b; this.onError = d; this.onFault = e; this.serialize = c; g.enabled && (h.console = this.wrapConsoleObject(h.console, g)) }; r.prototype =
    {
        ...
        discoverDependencies: function () {
            var a = { TrackJS: "3.10.1" }; g.jQuery && g.jQuery.fn && g.jQuery.fn.jquery && (a.jQuery = g.jQuery.fn.jquery); g.jQuery && g.jQuery.ui && g.jQuery.ui.version && (a.jQueryUI = g.jQuery.ui.version); g.angular && g.angular.version && g.angular.version.full &&
            ...
            return {
                age: (new Date).getTime() - this.loadedOn, dependencies: this.config.current.dependencies ? this.discoverDependencies() : { trackJs: "3.10.1" }, originalUrl: this.originalUrl,
        ...
        errorEndpoint: function (a) {
            ...
            c.isBrowser && !c.testCrossdomainXhr() && -1 === g.location.protocol.indexOf("https") ? d = b.errorNoSSLURL : b.forwardingDomain && (d = "https://" + b.forwardingDomain + "/capture"); return d + "?token=" + a + "&v=3.10.1"
        ...
        install: function (a) {
            ...
            var a = this, b = {
                addMetadata: this.metadata.addMetadata, attempt: function (b,
                    ...
                    }, version: "3.10.1", watch: function (b, e) { return function () { try { var f = Array.prototype.slice.call(arguments, 0); return b.apply(e || this, f) } catch (g) { throw a.onError("catch", g), c.wrapError(g); } } }, watchAll: function (a) { var b = Array.prototype.slice.call(arguments, 1), f; for (f in a) "function" !== typeof a[f] || c.contains(b, f) || (a[f] = this.watch(a[f], a)); return a }
