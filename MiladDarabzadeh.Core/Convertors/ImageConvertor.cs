...
namespace MiladDarabzadeh.Core.Convertors
{
    ...
    {
        public void Image_resize(string input_Image_Path, string output_Image_Path, int new_Width,int new_Height=0)
        {
            ...
            if (new_Height == 0)
            {
                new_Height = (int)(new_Width * relation_heigth_width);
            }
